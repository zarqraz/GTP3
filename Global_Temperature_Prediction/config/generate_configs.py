...
def generate_sklearn_configs():
    ...
    with open(f"config/generated_configs/config_sklearn_additional_no_scaler_7_window.json", 'w') as f:
...
def generate_keras_configs():
    ...
    with open(f"config/generated_configs/config_keras_2_no_scaler.json", 'w') as f:
